  ...
  return (
        <section>
          <a href="">
            ...
            className="rounded-full bg-gray-100/50 block lg:mt-5 mt-10 lg:mb-5 mb-10 mx-auto sm:float-right sm:ml-5 sm:mb-5 grayscale hover:grayscale-0 active:grayscale-0 object-contain w-auto rotate-0 hover:rotate-320 active:rotate-320 transition-all ease-in-out duration-700"/>
          </a>
